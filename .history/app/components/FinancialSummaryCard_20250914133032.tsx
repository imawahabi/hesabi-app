      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.amountSection}>
          <View style={styles.mainAmountRow}>
            ...
            {/* عداد الراتب القادم في تاب نظرة عامة */}
            {activeTab === 'overview' && (tabContent as any).salaryCountdown !== undefined && (
              <>
                <View style={styles.dividerLine} />
                <View style={styles.salaryCountdownContainer}>
                  <Text style={styles.salaryCountdownLabel}>الراتب خلال</Text>
                  <Text style={styles.salaryCountdownDays}>{(tabContent as any).salaryCountdown} يوم</Text>
                  <View style={styles.countdownProgress}>
                    <View style={[styles.progressBar, { width: `${Math.max(10, 100 - ((tabContent as any).salaryCountdown / 30) * 100)}%` }]} />
                  </View>
                </View>
              </>
            )}
