...
type Priority = 'urgent' | 'high' | 'normal' | string;

interface UpcomingCommitmentItem {
  id: string | number;
  overdue?: boolean;
  priority?: Priority;
  amount: number;
...
interface UpcomingCommitmentsProps {
  commitments: UpcomingCommitmentItem[];
}

const UpcomingCommitments: React.FC<UpcomingCommitmentsProps> = ({ commitments }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.listContainer}>
        {commitments.map((commitment: UpcomingCommitmentItem) => (
          <TouchableOpacity
            key={commitment.id}
