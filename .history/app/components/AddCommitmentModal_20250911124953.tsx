...
const AddCommitmentModal: React.FC<AddCommitmentModalProps> = ({
  ...
  const getChoiceOptions = () => [
    ...
    { 
      ...
      type: 'new', 
      icon: 'add-circle', 
      color: '#059669' // <--- Add color property here
    }
  ];
  ...
  const validateForm = () => {
    ...
    if (currentStep === 1) {
      ...
      if (!formData.paymentFrequency) {
        errors.paymentFrequency = 'تكرار الدفع مطلوب';
      }
      ...
      switch (selectedType?.id) {
        ...
        case 'installments_interest':
          if (!formData.merchantName?.trim()) {
            errors.merchantName = 'اسم المتجر مطلوب';
          }
          break;
        case 'cooperative':
        ...
        case 'utilities':
          ...
          break;
        case 'telecom':
          if (!formData.telecomProvider?.trim()) {
            errors.telecomProvider = 'اسم مقدم الخدمة مطلوب';
          }
          break;
        case 'insurance':
          if (!formData.insuranceCompany?.trim()) {
            errors.insuranceCompany = 'اسم شركة التأمين مطلوب';
          }
          break;
      }
    }
