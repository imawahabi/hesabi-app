...
const AddCommitmentModal: React.FC<AddCommitmentModalProps> = ({
  ...
  const commitmentTypes: CommitmentType[] = [
    ...
    { 
      id: 'insurance_health', 
      name: 'تأمين صحي', 
      description: 'بوليصات التأمين الصحي', 
      icon: 'medical', 
      color: '#EC4899' 
    },
    { 
      id: 'insurance_car', 
      name: 'تأمين سيارة', 
      description: 'تأمين المركبات الشامل والإجباري', 
      icon: 'car', 
      color: '#DC2626' 
    },
    { 
      id: 'insurance_travel', 
      name: 'تأمين سفر', 
      description: 'تأمينات السفر والسياحة', 
      icon: 'airplane', 
      color: '#059669' 
    }
  ];
  ...
  const getPreRegisteredData = (typeId: string) => {
    switch (typeId) {
      ...
      case 'insurance_health':
        return [
          { id: 'gulf_insurance', name: 'شركة الخليج للتأمين', policyNumber: 'GI2024001', coverage: 'تأمين صحي شامل', type: 'health_insurance', icon: 'medical', color: '#EC4899' },
          { id: 'warba_insurance', name: 'شركة وربة للتأمين', policyNumber: 'WI2024002', coverage: 'تأمين صحي عائلي', type: 'health_insurance', icon: 'heart', color: '#EF4444' },
          { id: 'kic', name: 'الشركة الكويتية للتأمين', policyNumber: 'KIC2024003', coverage: 'تأمين صحي فردي', type: 'health_insurance', icon: 'pulse', color: '#059669' }
        ];
      
      case 'insurance_car':
        return [
          { id: 'gulf_car_insurance', name: 'شركة الخليج - تأمين مركبات', policyNumber: 'GCI2024001', vehiclePlate: 'أ ب ج 123', type: 'car_insurance', icon: 'car', color: '#DC2626' },
          { id: 'warba_car_insurance', name: 'شركة وربة - تأمين مركبات', policyNumber: 'WCI2024002', vehiclePlate: 'د هـ و 456', type: 'car_insurance', icon: 'car-sport', color: '#F59E0B' },
          { id: 'ahlia_car_insurance', name: 'الأهلية للتأمين - مركبات', policyNumber: 'ACI2024003', vehiclePlate: 'ز ح ط 789', type: 'car_insurance', icon: 'shield', color: '#3B82F6' }
        ];
      
      case 'insurance_travel':
        return [
          { id: 'gulf_travel_insurance', name: 'شركة الخليج - تأمين سفر', policyNumber: 'GTI2024001', coverage: 'تأمين سفر دولي', type: 'travel_insurance', icon: 'airplane', color: '#059669' },
          { id: 'warba_travel_insurance', name: 'شركة وربة - تأمين سفر', policyNumber: 'WTI2024002', coverage: 'تأمين سفر إقليمي', type: 'travel_insurance', icon: 'globe', color: '#8B5CF6' }
        ];
  ...
  const getExistingEntitiesForType = (typeId: string) => {
    switch (typeId) {
      ...
      case 'insurance_health':
        return [
          { id: 'gulf_insurance_acc', name: 'شركة الخليج للتأمين', policyNumber: 'GI2024001', coverage: 'تأمين صحي شامل', commitmentCount: 1, type: 'health_insurance', icon: 'medical', color: '#EC4899' },
          { id: 'warba_insurance_acc', name: 'شركة وربة للتأمين', policyNumber: 'WI2024002', coverage: 'تأمين صحي عائلي', commitmentCount: 2, type: 'health_insurance', icon: 'heart', color: '#EF4444' }
        ];
      
      case 'insurance_car':
        return [
          { id: 'gulf_car_insurance_acc', name: 'شركة الخليج - تأمين مركبات', policyNumber: 'GCI2024001', vehiclePlate: 'أ ب ج 123', commitmentCount: 1, type: 'car_insurance', icon: 'car', color: '#DC2626' },
          { id: 'warba_car_insurance_acc', name: 'شركة وربة - تأمين مركبات', policyNumber: 'WCI2024002', vehiclePlate: 'د هـ و 456', commitmentCount: 1, type: 'car_insurance', icon: 'car-sport', color: '#F59E0B' }
        ];
      
      case 'insurance_travel':
        return [
          { id: 'gulf_travel_insurance_acc', name: 'شركة الخليج - تأمين سفر', policyNumber: 'GTI2024001', coverage: 'تأمين سفر دولي', commitmentCount: 1, type: 'travel_insurance', icon: 'airplane', color: '#059669' }
        ];
