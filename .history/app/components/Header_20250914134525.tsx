  ...
  return (
    <View style={styles.headerContainer}>
      ...
      <View style={styles.welcomeContainer}>
        ...
        {/* Practical info row: unread notifications + nearest reminder */}
        <View style={styles.infoRow}>
          {/* Unread count */}
          <View style={styles.infoBadge} accessibilityRole="text" accessibilityLabel="عدد التنبيهات غير المقروءة">
            <Ionicons name="notifications" size={14} color="#fff" style={styles.infoIcon} />
            <Text style={styles.infoText}>لديك {notifications.filter(n => !n.read).length} تنبيه غير مقروء</Text>
          </View>
          {/* Nearest reminder (if any) */}
          {notifications.find(n => n.type === 'reminder') && (
            <View style={styles.infoBadge} accessibilityRole="text" accessibilityLabel="أقرب تذكير">
              <Ionicons name="alarm" size={14} color="#fff" style={styles.infoIcon} />
              <Text style={styles.infoText}>أقرب تذكير: {notifications.find(n => n.type === 'reminder')?.time}</Text>
            </View>
          )}
        </View>
      </View>
